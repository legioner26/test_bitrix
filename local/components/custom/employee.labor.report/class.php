...
class EmployeeLaborReport extends CBitrixComponent
{
    ...
    private function getGridColumns(array $sorting = []): array
    {
        $columns = [
            [
                'id'      => 'FIO',
    ...
    private function getFilterValues(array $filterFields): array
    {
    ...
    private function buildQueryFilter(array $filterValues): array
    {
        $filter = [];
    ...
    private function persistGridSortingFromRequest(): void
    {
    ...
    private function normalizePersistedGridSortCase(): void
    {
        $gridOptions = new \CGridOptions(self::GRID_ID);
    ...
    private function getGridSorting(): array
    {
    ...
    private function toGridSortOrder(string $order): string
    {
        return strtoupper($order) === 'DESC' ? 'desc' : 'asc';
    }

    private function sortRows(array $rows, array $sorting): array
    {
    ...
    private function formatGridRows(array $rows): array
    {
        $gridRows = [];
